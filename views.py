...
def cadastrar_vendedor(request):
    ...
    if request.method == "POST":
        ...
        if user.exists():
            #Utitlizar messages do Django 
            return HttpResponse('Email já existe no sistema')
        ...
        messages.add_message(request, messages.SUCCESS, 'Usuário cadastrado')
...
def login(request):
    ...
    return HttpResponse('Login Sucesso')
